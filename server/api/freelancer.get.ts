const freelancer = [
  ...
  },
  {
    ...
    stunden_monat: 26 * 4,
    name: "Dani Berg",
    job: { job_title: "Game Developer", multiplier: 2.5 },
  },
  {
    id: "12",
    lohn_stunde: 68,
    stunden_monat: 20 * 4,
    name: "Marc Bürstos",
    job: { job_title: "Backend Developer", multiplier: 1.9 },
  },
  {
    id: "13",
    lohn_stunde: 69,
    stunden_monat: 18 * 4,
    name: "Bernd Priska",
    job: { job_title: "UI/UX Designer", multiplier: 1.7 },
  },
  {
    id: "14",
    lohn_stunde: 50,
    stunden_monat: 12 * 4,
    name: "Lucasz Derda",
    job: { job_title: "Frontend Developer", multiplier: 1.5 },
  },
  {
    id: "15",
    lohn_stunde: 46,
    stunden_monat: 32 * 4,
    name: "Dorminek Bayer",
    job: { job_title: "DevOps Engineer", multiplier: 1.5 },
  },
  {
    id: "16",
    lohn_stunde: 80,
    stunden_monat: 16 * 4,
    name: "Jonathan Trunk",
    job: { job_title: "AI Researcher", multiplier: 2.2 },
  },
  {
    id: "17",
    lohn_stunde: 90,
    stunden_monat: 18 * 4,
    name: "Oliver Mutig",
    job: { job_title: "Source Code Management Build Engineer", multiplier: 2.3 },
  },
  {
    id: "18",
    lohn_stunde: 78,
    stunden_monat: 27 * 4,
    name: "Ben Mut-Finkh",
    job: { job_title: "UI/UX Designer", multiplier: 1.8 },
  },
  {
    id: "19",
    lohn_stunde: 85,
    stunden_monat: 21 * 4,
    name: "Marlon Scheum",
    job: { job_title: "SEO Specialist", multiplier: 2.3 },
  },
  {
    id: "20",
    lohn_stunde: 75,
